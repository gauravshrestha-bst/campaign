...
// 		conditions: {
// 			eCPM: this.props.conditions.ecpm,
// 			eCPC: this.props.conditions.ecpc,
// 			eCPCI: this.props.conditions.ecpi,
// 			installs: this.props.conditions.installs,
// 			impressions: this.props.conditions.impressions,
// 			spend: this.props.conditions.spend,
// 			clicks: this.props.conditions.clicks
// 		}
// 	}
// 	handleChange=(event)=> {
//         this.setState({
...
// 					<input onChange={this.handleChange} type="text" name="ruleName" placeholder={}/>
// 				</div>
// 				<div className="field">
